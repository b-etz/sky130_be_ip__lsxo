...
T {Typical crystal voltage waveforms during operation} 320 -30 0 0 0.4 0.4 {}
N 40 -720 110 -720 {
lab=#net1}
N 600 -570 600 -510 {
lab=xout}
...
C {devices/code_shown.sym} 990 -350 0 0 {name=CONTROL only_toplevel=false value=".save v(dout)

.control
   let vstart=\{Vdvdd\}*0.9
   let vstop=\{Vdvdd\}*0.1
   tran 0.5n 0.2m
   meas tran tstart WHEN v(dout)=vstart FALL=2
   meas tran tstop WHEN v(dout)=vstop TD=tstart FALL=1
   let Tf=tstop-tstart
   set wr_singlescale
   wrdata \{simpath\}/\{filename\}_\{N\}.data Tf
   quit
.endc"}
C {devices/code_shown.sym} 990 -580 0 0 {name=SETUP only_toplevel=false value="* CACE gensim simulation file \{filename\}_\{N\}
* Generated by CACE gensim, Efabless Corporation (c) 2023
* Find the 90%-10% falling edge time on 'dout'

...
C {devices/vsource.sym} 190 -560 0 0 {name=Vdvss value=\{Vdvss\} savecurrent=false}
C {devices/gnd.sym} 190 -530 0 0 {name=l3 lab=GND}
C {devices/vsource.sym} 190 -430 0 0 {name=Vavss value=\{Vavss\} savecurrent=false}
C {devices/gnd.sym} 190 -400 0 0 {name=l4 lab=GND}
C {devices/lab_pin.sym} 190 -460 2 0 {name=p8 sig_type=std_logic lab=avss}
C {devices/lab_pin.sym} 190 -590 2 0 {name=p9 sig_type=std_logic lab=dvss}
...
C {devices/vsource.sym} 40 -320 0 0 {name=Vena1 value="PULSE(0 \{Vdvdd\} 0 10n 10n 10m 11m)" savecurrent=false}
C {devices/vsource.sym} 40 -210 0 0 {name=Vstby1 value="PULSE(\{Vdvdd\} 0 50u 10n 10n 10m 11m)" savecurrent=false}

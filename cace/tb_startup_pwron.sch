...
C {devices/vsource.sym} 320 -490 0 0 {name=Vdvss value=\{Vdvss\} savecurrent=false}
C {devices/gnd.sym} 320 -460 0 0 {name=l3 lab=GND}
C {devices/vsource.sym} 320 -370 0 0 {name=Vavss value=\{Vavss\} savecurrent=false}
C {devices/gnd.sym} 320 -340 0 0 {name=l4 lab=GND}
C {devices/lab_pin.sym} 320 -400 2 0 {name=p8 sig_type=std_logic lab=avss}
C {devices/lab_pin.sym} 320 -520 2 0 {name=p9 sig_type=std_logic lab=dvss}

...
*let tstart=teval+5u
*let tend=teval+10u
*meas tran Vol MAX v(dout) from=tstart to=tend

*set wr_singlescale
*wrdata \{simpath\}/\{filename\}_\{N\}.data Vol
*quit
.endc
"}
...
spice_ignore=false
place=header}
C {devices/vsource.sym} 580 -170 0 0 {name=Vxout value="DC 0.5378
+SIN(0.5378 0.1027 32768 0 0 130)" savecurrent=false}
C {devices/vsource.sym} 540 -90 0 0 {name=Vxin value="DC 0.545 
+SIN(0.5450 0.0842 32768 0 0 0)" savecurrent=false}

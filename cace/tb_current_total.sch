...
C {devices/code_shown.sym} 980 -290 0 0 {name=CONTROL only_toplevel=false value=".control
tran 500p 10u
set wr_singlescale
...
.endc
"}
C {devices/code_shown.sym} 980 -540 0 0 {name=SETUP only_toplevel=false value="* CACE gensim simulation file \{filename\}_\{N\}

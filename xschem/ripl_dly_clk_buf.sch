...
N 30 40 160 40 {
lab=clkena_b}
C {ena_rip_dly.sym} 80 -290 0 0 {name=x5}
...
C {devices/lab_pin.sym} 190 -300 2 0 {name=p62 sig_type=std_logic lab=ena_done}
...
C {devices/lab_pin.sym} 190 -170 2 0 {name=p67 sig_type=std_logic lab=stby_done}
...
C {devices/lab_pin.sym} -240 -70 0 0 {name=p74 sig_type=std_logic lab=ena_b}
C {devices/lab_pin.sym} -240 50 0 0 {name=p75 sig_type=std_logic lab=stby_done}
C {devices/lab_pin.sym} -240 10 0 0 {name=p76 sig_type=std_logic lab=stby}
C {devices/lab_pin.sym} -240 -30 0 0 {name=p77 sig_type=std_logic lab=ena_done}
C {devices/lab_pin.sym} -30 -10 3 0 {name=p78 sig_type=std_logic lab=clkena_b}
C {devices/lab_pin.sym} 200 -50 2 0 {name=p81 sig_type=std_logic lab=clkout}
C {stby_rip_dly.sym} 80 -160 0 0 {name=x6}
...
C {sky130_stdcells/ebufn_2.sym} 100 -50 0 0 {name=x7 VGND=dvss VNB=dvss VPB=dvdd VPWR=dvdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/o22ai_2.sym} -160 -10 0 0 {name=x8 VGND=dvss VNB=dvss VPB=dvdd VPWR=dvdd prefix=sky130_fd_sc_hd__ }
...
C {devices/noconn.sym} 190 -280 2 0 {name=l1}
C {devices/noconn.sym} 190 -150 2 0 {name=l2}

...
C {devices/code_shown.sym} 850 -250 0 0 {name=CONTROL only_toplevel=false value=".control
tran 1n 50u
set wr_singlescale
wrdata \{simpath\}/\{filename\}_\{N\}.data mean(-I(Vavdd))+mean(-I(Vdvdd)))
quit
.endc
"}
C {devices/code_shown.sym} 850 -500 0 0 {name=SETUP only_toplevel=false value="* CACE gensim simulation file \{filename\}_\{N\}

...
N 580 -260 580 -200 {
lab=#net5}
C {devices/vsource.sym} 40 -560 0 0 {name=Vdvdd value=1.8 savecurrent=false}
C {devices/vsource.sym} 40 -430 0 0 {name=Vavdd value=5.5 savecurrent=false}
...
C {devices/vsource.sym} 40 -320 0 0 {name=Vena value=1.8 savecurrent=false}
...
.endc
"}
C {devices/code_shown.sym} 990 -620 0 0 {name=SETUP only_toplevel=false value="* CACE gensim simulation file \{filename\}_\{N\}
...
C {devices/code.sym} 980 -770 0 0 {name=TT_MODELS1
only_toplevel=true
